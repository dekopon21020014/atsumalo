    ...
    <main className="container mx-auto p-8">
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>本サービスは「現状有姿（AS-IS）」で提供されます。当方は、本サービスにエラーやバグがないこと、特定の目的に適合すること、および常時利用可能であることを一切保証しません。</li>
          <li>当方は、本サービスの利用、データの消失、またはサービスの一時停止・終了によってユーザーに生じたあらゆる損害（直接的、間接的を問わず）について、一切の責任を負いません。</li>
          <li>ユーザー間または第三者との間で生じたトラブルについて、当方は一切関与せず、責任を負いません。</li>
          <li>本サービスは、事前の予告なく仕様の変更、または提供を停止・終了する場合があります。</li>
        </ul>
      </section>
